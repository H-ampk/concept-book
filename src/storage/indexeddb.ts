...
export const sanitizeConcept = (
  ...
  const normalized: Concept = {
    ...
    ...(concept.sourceContextCardId
      ? { sourceContextCardId: concept.sourceContextCardId }
      : {}),
    ...(concept.autoGenerated !== undefined
      ? { autoGenerated: Boolean(concept.autoGenerated) }
      : {}),
    ...(concept.sourceContextCardTermKey
      ? { sourceContextCardTermKey: concept.sourceContextCardTermKey }
      : {})
  };
