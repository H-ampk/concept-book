...
const DecorativeBackground = () => (
  <div className="fixed inset-0 pointer-events-none z-[1] overflow-hidden">
    <div className="absolute inset-0 bg-gradient-radial from-nordic-bgAlt via-nordic-bg to-nordic-muted opacity-90"></div>
        ...
        className={
          screen === "concepts" && conceptMainTab === "graph"
            ...
            : screen === "concepts" && conceptMainTab === "tree"
              ...
              : screen === "data-lab" || screen === "analysis-dashboard"
                ? "relative z-10 w-full min-w-0 py-4"
